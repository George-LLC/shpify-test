...
var btnShopping = document.querySelector('.main-pageLIQUID .main .main__title_button button');
var headerLogo = document.querySelector('.header-logo');
var mainHtml = document.querySelector('.main-pageLIQUID');
var shoppingHTML = document.querySelector('.productLIQUID');
var menuPopup = document.querySelector('.menu__popup');
var karzinkaPopup = document.querySelector('.header .header__container .karzinka__popup');
...
var main = document.querySelector('.main-pageLIQUID .main');
...
for (let elem of allKarzinka) {
    elem.addEventListener('click', function() {
        console.log("Hayko ktpem qez xeloq mna");
        mainDisplay = getComputedStyle(main).display;
        shopingDisplay = getComputedStyle(shoppingHTML).display;
